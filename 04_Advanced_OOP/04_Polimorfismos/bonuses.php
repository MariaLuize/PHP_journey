...
use Alura\Bank\MOdel\Employee\{Employee, Manager, CEO, Dev};
use Alura\Bank\Service\BonusController;

$cpf1           = new CPF('645.616.546-41');
$funcionario    = new CEO($cpf1, 'Luize Maria', 'CEO', 3000);

// $cpf2           = new CPF('514.126.576-11');
// $funcionario2   = new Employee($cpf2, 'Luan Pinheiro', 'RI', 1000);

$cpf3           = new CPF('514.126.576-11');
$funcionario3   = new Manager($cpf3, 'Pinheiro', 'Manager', 2000);

$cpf4           = new CPF('867.781.866-18');
$funcionario4   = new Dev($cpf4, 'Nome abs', 'Dev', 1500);
