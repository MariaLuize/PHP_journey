...
abstract class Account
{
    ...
    protected float  $saldo; //é protected pq o método saca() é usado em uma classe filha, a PoupancaAccount.php
    ...
    {
        /*  É possivel usar o método bankFeePercentage(), mesmo ainda sendo abstract, pois em algum momento 
            ele será implementado */
        $tarifaSaque = $value*$this->bankFeePercentage();
        $valueSaque  = $value+$tarifaSaque;

        if ($valueSaque > $this->saldo){
    ...
    */
    ...
    /**
     * Todas as classes que usarem a classe Account como parent, DEVEM IMPLEMENTAR O MÉTODO bankFeePercentage(), pois ele é abstract
     * O fato de haver um método abstract, faz com que a classe Account toda seja considerada abstract. 
     * Logo, não é possível mais criar (instanciar) um objeto Account, apenas criar as classes filhas dele 
    */
    abstract protected function bankFeePercentage():float;
